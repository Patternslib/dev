...
* Makefile: Release npm and github in one go, avoiding many of the quirks like double builds and double changelog generation. ([8f01836](https://github.com/Patternslib/dev/commit/8f018368819be86bc9c4e703f7d9574a16fc3322))


* Makefile: Update browserslist database before bundling. ([8e3da59](https://github.com/Patternslib/dev/commit/8e3da5993cc657bf8aee3fef40fcc414f0ed3cff))
...
* Makefile‌: checkout changes before running release-it which would break if it is modified. ([db0e89e](https://github.com/Patternslib/dev/commit/db0e89ec0fb918cd64accdd2c285e09202936396))


* Remove version pin for conventional-changelog-conventionalcommits. This is finally fixed upstream in conventional-changelog/commitlint. ([333c802](https://github.com/Patternslib/dev/commit/333c802d9913e18fe8673b2263a24776bba9bc34))


### Maintenance


* Add missing @eslint/js dependency. ([02eb557](https://github.com/Patternslib/dev/commit/02eb5573591d13f114f7fce0b9e81b8ad07fd986))


* eslint latest ECMA script and drop @babel/eslint-parser. ([efdc5f1](https://github.com/Patternslib/dev/commit/efdc5f145b1a3bb32c4c2469e8aeeec8b0d29e44))
...
* Upgrade dependencies. ([4ae9820](https://github.com/Patternslib/dev/commit/4ae98209d0ff5a2e3db882996c4b462cb94ca6a6))
...
* Add postinstall script to upgrade dev. ([16b900d](https://github.com/Patternslib/dev/commit/16b900d554591c4c6511b2cbd3f503dc882b14d1))
...
* Add upgrade to remove husky. ([6e3629c](https://github.com/Patternslib/dev/commit/6e3629c08c349224b48863d9e922cce303c4e2c4))


* Directly use git's commit hooks and remove dependency on husky. ([ae05dd3](https://github.com/Patternslib/dev/commit/ae05dd37bc3df6261db4a5eecbaed3d789812300))


* Makefile: Define targets as phony, if they are. ([d4c63b7](https://github.com/Patternslib/dev/commit/d4c63b71909c07dc1915f755c5f54da0dd3e5737))


* Makefile: Let the install target depend on yarn.lock file to allow reinstalls when yarn.lock changes. ([9de2d28](https://github.com/Patternslib/dev/commit/9de2d28d15601ec8c81527753ba480eac7bc720d))


* Upgrade dependencies. ([74027e8](https://github.com/Patternslib/dev/commit/74027e89abe08a511a8d6f9c82a2e852c36584d6))


* Upgrade to eslint v9. ([1279e70](https://github.com/Patternslib/dev/commit/1279e70f4f276a46eb0459cd0b6dd1ab628c4c44))
...
* Include changelog from pre-releases in final. ([b053a10](https://github.com/Patternslib/dev/commit/b053a103ae859b1c33904d48fd80076cbec040eb))

  When doing a final release after a series of pre-releases, include all
...
* **Webpack:** Add the version banner only to the entry point files. ([6f82df1](https://github.com/Patternslib/dev/commit/6f82df1d3215c07d4ff4cc00d3d6fc56f9f1fdca))

  This fixes a problem where each chunk file was changed with a new release, even if nothing else than the version has changed.
...
* Allow to add the compiled bundles to npm packages. ([84bdefd](https://github.com/Patternslib/dev/commit/84bdefd339b9aa553ef78e9448e4cdd998178d40))

  Creating a npm release with the Makefile prepares now a bundle build
...
* **Tests:** Remove dependency on jQuery. ([259d801](https://github.com/Patternslib/dev/commit/259d801ab0a203ea64073e3cc0366976a38f1e0c))
...
* **Tests:** Remove the Dependency on @patternslib/patternslib. ([afe8fee](https://github.com/Patternslib/dev/commit/afe8feec6304d2ce184afd587d429f3ae5bd533c))
...
* **Makefile:** Add empty bundle-pre target for customization. ([0290e61](https://github.com/Patternslib/dev/commit/0290e61fac9230e24428dd0b846c5bace145f56d))

  The empty bundle-pre target is run before the bundle target and can be
...
* **Webpack:** Add bundle name and version to the banner. ([1058b6d](https://github.com/Patternslib/dev/commit/1058b6d58b6e05c0c841a02a753a7fd823688595))

  For this, you have to pass your project's package.json as argument to the webpack config factory.
Both values - name and version - are taken from the package.json data.


* **Webpack:** Add config export with named parameters. ([f7b2471](https://github.com/Patternslib/dev/commit/f7b24711ce223eaa51e0ea819643a656cae846f3))
...
* **Module Federation:** Add a shared parameter for MF config factory. ([22e4b5e](https://github.com/Patternslib/dev/commit/22e4b5e0a4d933a61008c5f203c90ad94d6b084f))

  The shared parameter allows to directly provide the shared object for the Webpack Module Federation Plugin.
...
* **webpack module federation:** Make wepack module federation config factory more explicit. ([efd266c](https://github.com/Patternslib/dev/commit/efd266cfc82372c467eb6a8b470360b72647b9bd))

  Change signature of the webpack mf config factory to make it simpler, more flexible and more explicit at the cost of having to pass more options.
...
* Do not build a bundle and a release-zip for @patternslib/dev. ([085a019](https://github.com/Patternslib/dev/commit/085a019c16a8494a2d6fa0203d880325c996aba6))

  Still, we have the Makefile targets ``bundle`` and ``release-zip``
...
* Configure dependencies. ([4db723d](https://github.com/Patternslib/dev/commit/4db723dedd245f2c71fe9367b7f82bec1179c024))

  Use dependencies field in package.json to install all development dependencies.
